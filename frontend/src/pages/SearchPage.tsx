        ...
        <main className="flex-1 overflow-y-auto flex flex-col-reverse">
          <div className="flex gap-8 max-w-6xl mx-auto px-4 md:px-6 py-4 w-full">
            <div className="flex-1 min-w-0 max-w-[700px]">
              ...
              {/* Infinite Scroll Sentinel (Movido para cima para reverse scroll) */}
              <div ref={sentinelRef} className="py-6 flex justify-center order-first">
