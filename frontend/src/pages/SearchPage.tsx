      ...
      <div className="flex flex-1 min-h-0">
        ...
        <main className="flex-1 flex flex-col relative overflow-hidden bg-slate-50 dark:bg-surface-900">
          ...
          <div className="absolute inset-0 w-full h-full flex flex-col pt-12 pb-4">
            ...
            {!loading && data && (data.results.length > 0 || data.knowledgePanel) && (
              <div 
            ...
            {!loading && data && data.results.length === 0 && !data.knowledgePanel && (
              <div className="flex-1 flex flex-col items-center justify-center p-6 text-center animate-fade-in">
                <div className="w-16 h-16 rounded-full bg-slate-100 dark:bg-surface-800 flex items-center justify-center mb-4">
